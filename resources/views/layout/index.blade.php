                            ...
                            <div class="d-flex align-items-center w-100">
                                ...
                                <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo01">
                                    <ul class="navbar-nav mb-2 mb-lg-0 ml-2">
                                        ...
                                        <li><a href="{{ route('home') }}" class="nav-link active" aria-current="page">Beranda</a>
                                        </li>
                                        <li><a href="{{ route('paket.index') }}" class="nav-link active" aria-current="page">Paket
                                                Tur</a></li>
                                        {{-- <li><a href="{{route('ruang-media.index')}}" class="nav-link active" aria-current="page">Paket Educational Trip</a></li> --}}
                                        <li><a href="{{ route('ruang-media.index') }}"
                                                class="nav-link active" aria-current="page">Ruang Media</a></li>
                                        <li><a href="{{ route('sewa.transportasi') }}"
                                                class="nav-link active" aria-current="page">Sewa Transportasi</a></li>
                                        <li><a href="{{ route('tes.timoni') }}"
                                                class="nav-link active" aria-current="page">Testimoni</a></li>
                                        <li><a href="{{ route('about.as') }}" class="nav-link active" aria-current="page">Tentang
                                                Kami</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <ul class="footer-menu text-white">
                                    ...
                                    <li>
                                        <a href="{{ route('paket.index') }}" style="text-decoration: none;" class="text-white">Paket Tur</a>
                                    </li>
                                    {{-- <li>
                                        <a href="#" class="text-white">Paket Educational Trip</a>
                                    </li> --}}
                                    <li>
                                        <a href="{{ route('ruang-media.index') }}" style="text-decoration: none;" class="text-white">Ruang
                                            Media</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('sewa.transportasi') }}" style="text-decoration: none;" class="text-white">Sewa Transportasi</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('tes.timoni') }}" style="text-decoration: none;" class="text-white">Testimoni</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('about.as') }}" style="text-decoration: none;" class="text-white">Tentang
                                            Kami</a>
                                    </li>
                                </ul>
                            </div>
