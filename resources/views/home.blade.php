    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <main id="main">
                ...
                <section class="slider relative">
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            @for($i = 0; $i < 3; $i++)
                            <div class="slider-home1 relative overflow-hidden swiper-slide" style="background-image: url({{asset('assets/slide/slide.png')}}); background-size: cover; background-position: center;">
                                    ...
                                    <div class="tf-container">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <h1 class="title-slide text-white mb-32 fadeInDown wow">5D Japan Explore Raja Ampat
                                                    ...
                                                    <div class="tab-pane fade show active" id="new-york-tab-pane" role="tabpanel"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6 col-sm-6 col-lg-3 mt-4">
                                                               <img src="{{asset('assets/slide/slide.png')}}" alt="" width="100%" height="100%">
                                                            </div> 
                                                            <div class="col-6 col-sm-6 col-lg-3 mt-4">
                                                               <img src="{{asset('assets/slide/slide.png')}}" alt="" width="100%" height="100%">
                                                            </div> 
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-12">
                                <div class="center m0-auto w-text-heading">
                                    ...
                                    <h3 class="title-heading ">Jelajahi setiap sudut Indonesia bersama Daffana Nusantara </h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mx-auto mb-3">
                                <div class="position-relative">
                                    <img src="{{asset('assets/slide/slide.png')}}" alt="" class="rounded" style="border-radius: 15px;">
                ...
                <!-- Widget Counter -->
                <section class=" relative" style="background-image: url({{asset('assets/item/elips18.png')}});   cover; background-position: center;"> 
                    <div class="tf-container">
                        <div class="row mb-50">
